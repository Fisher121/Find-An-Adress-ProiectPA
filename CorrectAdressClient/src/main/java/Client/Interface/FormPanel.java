...
public class FormPanel extends JPanel {
    ...
    void init(){
        ...
        countryLabel = new JLabel(mainframe.message.getString("country"));
        countryField = new JTextField("Some country");
        countryField.setSize(new Dimension(W/10,H/10));
        stateLabel = new JLabel(mainframe.message.getString("state"));
        stateField = new JTextField("Some state");
        cityLabel = new JLabel(mainframe.message.getString("city"));
